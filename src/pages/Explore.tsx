    ...
    <div className="flex min-h-screen bg-[#1E293B] text-white">
      ...
      <main className="flex-1 px-6 py-8">
        <div className="max-w-7xl mx-auto">
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-4xl font-bold text-[#34D399] mb-3">Explorar</h1>
            <p className="text-[#94A3B8] text-lg">
              Descubre comunidades y contenido que te inspire
            </p>
          </div>
              ...
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  {communities.map((community) => (
                    <div
                      key={community.id}
                      className="bg-[#0F172A] rounded-2xl overflow-hidden border border-[#334155] hover:border-[#34D399]/50 transition-all duration-300 cursor-pointer group"
                    >
              ...
              <section>
                ...
                <div className="space-y-4">
                  {recommendedPosts.map((post) => (
                    ...
                    >
                      <h3 className="font-bold text-xl mb-3 group-hover:text-[#34D399] transition">
                        {post.title}
                      </h3>
                      <p className="text-sm text-[#94A3B8] mb-4 leading-relaxed">
                        {post.description}
